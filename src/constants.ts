...
export const SERVICES_TILES: TileData[] = [
  {
    ...
    type: ContentType.TEXT,
    content: {
      text: '<div class="flex flex-col items-start text-left"><h4 class="font-medium text-base mb-0 uppercase tracking-wider text-[#194D25] md:-ml-2">transparantie en privacy</h4></div>',
    } as TextContent,
    fillColor: '#AEB5B9',
  },
  {
    ...
    type: ContentType.TEXT,
    content: {
      text: '<div class="flex flex-col items-start text-left"><h4 class="font-medium text-base mb-0 uppercase tracking-wider text-[#194D25] md:-ml-2">bias en rechtvaardigheid</h4></div>',
    } as TextContent,
    fillColor: '#AEB5B9',
  },
  {
    ...
    type: ContentType.TEXT,
    content: {
      text: '<div class="flex flex-col items-start text-left"><h4 class="font-medium text-base mb-0 uppercase tracking-wider text-[#194D25] md:-ml-2">menselijke regie</h4></div>',
    } as TextContent,
    fillColor: '#AEB5B9',
  },
];
