...
export const SERVICES_DETAILS: Record<string, string> = {
  'serv-1': `<div class="flex flex-col items-start text-left"><h4 class="font-bold text-base mb-3 uppercase tracking-wider text-[#194D25]">transparantie, privacy en toegankelijkheid</h4><p class="text-sm md:text-base leading-relaxed max-w-2xl">Onze basistest ten aanzien van publiek vertrouwen. Wij testen of uw AI-besluiten en uitingen voldoende transparant, privacygevoelig en toegankelijk zijn. En daarmee of uw toepassing voldoet aan de gangbare normen zoals de EU AI Act of richtlijnen op het vlak van mensenrechten.</p></div>`,
